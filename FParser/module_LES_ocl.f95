!!! This code was generated on Wed  4 Dec 2013 10:05:14 GMT from module_LES_ocl_TEMPL.f95 gen_OpenCL_API_calls 
!!! DO NOT EDIT !!! Edit module_LES_ocl_TEMPL.f95 instead, and regenerate.
#define ianime 0
#define ifbf 1
...
! sizes
 ...
 ! convert to new format
       ...
       ! opencl-specific code
        ...
        uvw_sz = (/ 4, 152, 153, 93 /)
        fgh_sz = (/ 4, 151, 151, 91 /)
        fgh_old_sz = (/ 4, 150, 150, 90 /)
        cov_sz = (/ 16, 154, 153, 93 /)
        diu_sz = (/ 16, 154, 153, 93 /)
        nou_sz = (/ 16, 154, 153, 93 /)
