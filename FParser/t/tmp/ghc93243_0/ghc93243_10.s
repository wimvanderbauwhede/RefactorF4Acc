...
.text
.align 3
	.quad	_S2vo_srt-(_s2si_info)+272
	.quad	0
	.quad	-3458764509525573616
_s2si_info:
Lc35g:
	leaq -40(%rbp),%rax
	cmpq %r15,%rax
...
Lc35j:
	...
	movq _stg_ap_pp_info@GOTPCREL(%rip),%rbx
	movq %rbx,-40(%rbp)
	leaq _F95ParserCommon_comma_closure(%rip),%rbx
	movq %rbx,-32(%rbp)
	movq %rax,-24(%rbp)
	addq $-40,%rbp
	jmp _base_GHCziBase_zgzg_info
...
.text
.align 3
	.quad	_S2vo_srt-(_s2sj_info)+272
	.quad	0
	.quad	-3457638609618730992
_s2sj_info:
Lc35l:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
...
.text
.align 3
	.quad	_u37F_srtd-(_F95VarDeclParser_f95zuvarzudeclzuparser_info)+0
	.quad	0
	.quad	-4294967274
