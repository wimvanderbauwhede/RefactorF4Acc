!!! This code was generated on Fri Aug 30 10:25:55 2013 from module_LES_ocl_TEMPL.f95 using ./generate_OpenCL_API_calls_from_ACC_pragmas.pl
...
! Combined arrays for OpenCL kernels
        ...
        real(kind=4), dimension(1:9,-1:ip+2,0:jp+2,0:kp+2)  :: cov
        real(kind=4), dimension(1:9,-1:ip+2,0:jp+2,0:kp+2)  :: diu
        real(kind=4), dimension(1:9,-1:ip+2,0:jp+2,0:kp+2)  :: nou
