...
1. The names are way too long. => I solved this by shortening the names with `crypt()`
...
The StmtCount mechanism is broken. The purpose is to identify multiple lines in a source that could become declarations.
But rather than having a count, we should have the line type I think.
