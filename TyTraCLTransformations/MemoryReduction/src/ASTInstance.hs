...
ast = [
       ...
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu1_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s12")) (Vec VT (Scalar VDC DFloat "diu1_1")))
       ...
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov1_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s12")) (Vec VT (Scalar VDC DFloat "cov1_1")))
...
main :: (Vec 8418552 Float,Vec 8510058 Float,Vec 8418552 Float,SVec 303 Float,SVec 302 Float,SVec 94 Float,SVec 94 Float) -> (Vec 8244691 Float,Vec 8244691 Float,Vec 8244691 Float)
main (u_0,w_0,v_0,dx1_0,dy1_0,dzn_0,dzs_0) =
  let
     -- velfg_map_76
    ...
    s3 = [605,91809,91810,92110,92111]
    ...
    s8 = [92113,92114]
    cov4_s_0 = stencil s8 cov4_1
    s9 = [92113,92114]
    cov7_s_0 = stencil s9 cov7_1
    s10 = [92113,92416]
    cov8_s_0 = stencil s10 cov8_1
    s11 = [92418,92722]
    diu5_s_0 = stencil s11 diu5_1
    s12 = [92418,92419]
    diu1_s_0 = stencil s12 diu1_1
    s13 = [92113,183922]
    diu9_s_0 = stencil s13 diu9_1
    s14 = [92113,92416]
    diu2_s_0 = stencil s14 diu2_1
    s15 = [92113,183922]
    diu3_s_0 = stencil s15 diu3_1
    s16 = [92418,92419]
    cov1_s_0 = stencil s16 cov1_1
    s17 = [92113,183922]
    cov9_s_0 = stencil s17 cov9_1
    s18 = [92113,92416]
    cov2_s_0 = stencil s18 cov2_1
    s19 = [92113,183922]
    ...
    s22 = [92113,92114]
    diu7_s_0 = stencil s22 diu7_1
    s23 = [92113,92416]
    diu8_s_0 = stencil s23 diu8_1
    s24 = [92418,92722]
    cov5_s_0 = stencil s24 cov5_1
