...
mainArgDeclsList = [
    ...
    , ("p4_1" , MkFDecl "real"  (Just [(1,2121446768)]) (Just Out) ["p4_1"] )
  ]
...
main (p0_0,rhs_0,global_id_0) =
  let
    ...
    p1_1 =  map (sor_map_23 global_id_0) (zipt (p0_s_0,rhs_0))
     -- sor_map_47
    s2 = [4803,23059205,23059207,23064006,23064007,23064008,23068807,23068809,46123211]
    p1_s_0 = stencil s2 p1_1
    p2_1 =  map (sor_map_47 global_id_0) (zipt (p1_s_0,rhs_0))
     -- sor_map_71
    s3 = [4803,23059205,23059207,23064006,23064007,23064008,23068807,23068809,46123211]
    p2_s_0 = stencil s3 p2_1
    p3_1 =  map (sor_map_71 global_id_0) (zipt (p2_s_0,rhs_0))
     -- sor_map_95
    s4 = [4803,23059205,23059207,23064006,23064007,23064008,23068807,23068809,46123211]
