...
ast = [
        ...
        ,(Vec VS (DSVec 3 DFloat) "eta_s_0" , Stencil (SVec 3 DInt "s4") (Vec VO DFloat "eta_1"))
        ...
        ,(Vec VS (DSVec 3 DInt) "wet_s_1" , Stencil (SVec 3 DInt "s7") (Vec VI DInt "wet_0"))
...
stencilDefinitionsList = [("s1" , [-502,-1,0,1,502] ), ("s2" , [-502,-1,0,1,502] ), ("s3" , [-502,0] ), ("s4" , [0,1,502] ), ("s5" , [-502,-1,0,1,502] ), ("s6" , [-1,0] ), ("s7" , [0,1,502] )]