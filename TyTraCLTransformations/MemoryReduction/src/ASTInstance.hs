...
ast = [
       ...
       ,( (Tuple [Vec VT (Scalar VDC DFloat "cov1_1"),Vec VT (Scalar VDC DFloat "cov2_1"),Vec VT (Scalar VDC DFloat "cov3_1"),Vec VT (Scalar VDC DFloat "cov4_1"),Vec VT (Scalar VDC DFloat "cov5_1"),Vec VT (Scalar VDC DFloat "cov6_1"),Vec VT (Scalar VDC DFloat "cov9_1"),Vec VT (Scalar VDC DFloat "diu1_1"),Vec VT (Scalar VDC DFloat "diu2_1"),Vec VT (Scalar VDC DFloat "diu3_1"),Vec VT (Scalar VDC DFloat "diu4_1"),Vec VT (Scalar VDC DFloat "diu5_1"),Vec VT (Scalar VDC DFloat "diu6_1"),Vec VT (Scalar VDC DFloat "diu9_1"),Vec VT (Scalar VDC DFloat "nou1_1"),Vec VT (Scalar VDC DFloat "nou2_1"),Vec VT (Scalar VDC DFloat "nou3_1"),Vec VT (Scalar VDC DFloat "nou4_1"),Vec VT (Scalar VDC DFloat "nou5_1"),Vec VT (Scalar VDC DFloat "nou6_1"),Vec VT (Scalar VDC DFloat "nou9_1")]), UnzipT ( Map (Function "velfg_map_76"  [FVec [(-1,301)] (Scalar VDC DFloat "dx1_0"),FVec [(0,301)] (Scalar VDC DFloat "dy1_0"),FVec [(-1,92)] (Scalar VDC DFloat "dzn_0"),FVec [(-1,92)] (Scalar VDC DFloat "dzs_0")]) (ZipT [Vec VS (SVec 5 (Scalar VDC DFloat "u_s_0")),Vec VS (SVec 5 (Scalar VDC DFloat "v_s_0")),Vec VS (SVec 4 (Scalar VDC DFloat "w_s_0"))]) ) )
        -- velfg_map_133
       ...
       ,( (Tuple [Vec VT (Scalar VDC DFloat "cov7_1"),Vec VT (Scalar VDC DFloat "cov8_1"),Vec VT (Scalar VDC DFloat "diu7_1"),Vec VT (Scalar VDC DFloat "diu8_1"),Vec VT (Scalar VDC DFloat "nou7_1"),Vec VT (Scalar VDC DFloat "nou8_1")]), UnzipT ( Map (Function "velfg_map_133"  [FVec [(-1,92)] (Scalar VDC DFloat "dzn_0"),FVec [(-1,301)] (Scalar VDC DFloat "dx1_0"),FVec [(0,301)] (Scalar VDC DFloat "dy1_0")]) (ZipT [Vec VS (SVec 2 (Scalar VDC DFloat "u_s_1")),Vec VS (SVec 3 (Scalar VDC DFloat "w_s_1")),Vec VS (SVec 2 (Scalar VDC DFloat "v_s_1"))]) ) )
        -- velfg_map_218
       ...
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu8_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s15")) (Vec VT (Scalar VDC DFloat "diu8_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov8_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s15")) (Vec VT (Scalar VDC DFloat "cov8_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov2_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s15")) (Vec VT (Scalar VDC DFloat "cov2_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu9_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s18")) (Vec VT (Scalar VDC DFloat "diu9_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov9_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s18")) (Vec VT (Scalar VDC DFloat "cov9_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu2_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s15")) (Vec VT (Scalar VDC DFloat "diu2_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu6_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s18")) (Vec VT (Scalar VDC DFloat "diu6_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov6_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s18")) (Vec VT (Scalar VDC DFloat "cov6_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov3_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s18")) (Vec VT (Scalar VDC DFloat "cov3_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu3_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s18")) (Vec VT (Scalar VDC DFloat "diu3_1")))
       ,( (Tuple [Vec VT (Scalar VDC DFloat "dfu1_1"),Vec VT (Scalar VDC DFloat "dfv1_1"),Vec VT (Scalar VDC DFloat "dfw1_1"),Vec VO (Scalar VDC DFloat "f_1"),Vec VO (Scalar VDC DFloat "g_1"),Vec VO (Scalar VDC DFloat "h_1")]), UnzipT ( Map (Function "velfg_map_218"  [FVec [(-1,301)] (Scalar VDC DFloat "dx1_0"),FVec [(0,301)] (Scalar VDC DFloat "dy1_0"),FVec [(-1,92)] (Scalar VDC DFloat "dzn_0"),FVec [(-1,92)] (Scalar VDC DFloat "dzs_0")]) (ZipT [Vec VS (SVec 2 (Scalar VDC DFloat "cov1_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov2_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov3_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu1_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu2_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu3_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov4_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov5_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov6_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu4_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu5_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu6_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov7_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov8_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov9_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu7_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu8_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu9_s_0"))]) ) )
        ]

functionSignaturesList = [
        ("velfg_map_133",  [Tuple [FVec [(-1,92)] (Scalar VI DFloat "dzn_0"),FVec [(-1,301)] (Scalar VI DFloat "dx1_0"),FVec [(0,301)] (Scalar VI DFloat "dy1_0")],Tuple [SVec 2 (Scalar VDC DFloat "u_s_1"),SVec 3 (Scalar VDC DFloat "w_s_1"),SVec 2 (Scalar VDC DFloat "v_s_1")],Tuple [Scalar VT DFloat "cov7_1",Scalar VT DFloat "cov8_1",Scalar VT DFloat "diu7_1",Scalar VT DFloat "diu8_1",Scalar VT DFloat "nou7_1",Scalar VT DFloat "nou8_1"]]),
        ("velfg_map_218",  [Tuple [FVec [(-1,301)] (Scalar VI DFloat "dx1_0"),FVec [(0,301)] (Scalar VI DFloat "dy1_0"),FVec [(-1,92)] (Scalar VI DFloat "dzn_0"),FVec [(-1,92)] (Scalar VI DFloat "dzs_0")],Tuple [SVec 2 (Scalar VDC DFloat "cov1_s_0"),SVec 2 (Scalar VDC DFloat "cov2_s_0"),SVec 2 (Scalar VDC DFloat "cov3_s_0"),SVec 2 (Scalar VDC DFloat "diu1_s_0"),SVec 2 (Scalar VDC DFloat "diu2_s_0"),SVec 2 (Scalar VDC DFloat "diu3_s_0"),SVec 2 (Scalar VDC DFloat "cov4_s_0"),SVec 2 (Scalar VDC DFloat "cov5_s_0"),SVec 2 (Scalar VDC DFloat "cov6_s_0"),SVec 2 (Scalar VDC DFloat "diu4_s_0"),SVec 2 (Scalar VDC DFloat "diu5_s_0"),SVec 2 (Scalar VDC DFloat "diu6_s_0"),SVec 2 (Scalar VDC DFloat "cov7_s_0"),SVec 2 (Scalar VDC DFloat "cov8_s_0"),SVec 2 (Scalar VDC DFloat "cov9_s_0"),SVec 2 (Scalar VDC DFloat "diu7_s_0"),SVec 2 (Scalar VDC DFloat "diu8_s_0"),SVec 2 (Scalar VDC DFloat "diu9_s_0")],Tuple [Scalar VT DFloat "dfu1_1",Scalar VT DFloat "dfv1_1",Scalar VT DFloat "dfw1_1",Scalar VO DFloat "f_1",Scalar VO DFloat "g_1",Scalar VO DFloat "h_1"]]),
        ("velfg_map_76",  [Tuple [FVec [(-1,301)] (Scalar VI DFloat "dx1_0"),FVec [(0,301)] (Scalar VI DFloat "dy1_0"),FVec [(-1,92)] (Scalar VI DFloat "dzn_0"),FVec [(-1,92)] (Scalar VI DFloat "dzs_0")],Tuple [SVec 5 (Scalar VDC DFloat "u_s_0"),SVec 5 (Scalar VDC DFloat "v_s_0"),SVec 4 (Scalar VDC DFloat "w_s_0")],Tuple [Scalar VT DFloat "cov1_1",Scalar VT DFloat "cov2_1",Scalar VT DFloat "cov3_1",Scalar VT DFloat "cov4_1",Scalar VT DFloat "cov5_1",Scalar VT DFloat "cov6_1",Scalar VT DFloat "cov9_1",Scalar VT DFloat "diu1_1",Scalar VT DFloat "diu2_1",Scalar VT DFloat "diu3_1",Scalar VT DFloat "diu4_1",Scalar VT DFloat "diu5_1",Scalar VT DFloat "diu6_1",Scalar VT DFloat "diu9_1",Scalar VT DFloat "nou1_1",Scalar VT DFloat "nou2_1",Scalar VT DFloat "nou3_1",Scalar VT DFloat "nou4_1",Scalar VT DFloat "nou5_1",Scalar VT DFloat "nou6_1",Scalar VT DFloat "nou9_1"]])
    ]
stencilDefinitionsList = [("s1" , [92111,92112,92413,183617] ), ("s2" , [605,91809,91810,92110,92111] ), ("s3" , [605,91809,92110,92111,92412] ), ("s4" , [91809,183315] ), ("s5" , [183315,183616,183617] ), ("s6" , [92110,183616] ), ("s7" , [92418,92419] ), ("s9" , [92418,92722] ), ("s11" , [92113,92114] ), ("s15" , [92113,92416] ), ("s18" , [92113,183922] )]
...
main (w_0,v_0,u_0,dx1_0,dy1_0,dzn_0,dzs_0) =
  let
    ...
    s12 = [92113,92114]
    cov4_s_0 = stencil s12 cov4_1
    s13 = [92113,92114]
    cov7_s_0 = stencil s13 cov7_1
    s14 = [92113,92114]
    diu7_s_0 = stencil s14 diu7_1
    s15 = [92113,92416]
    diu8_s_0 = stencil s15 diu8_1
    s16 = [92113,92416]
    cov8_s_0 = stencil s16 cov8_1
    s17 = [92113,92416]
    cov2_s_0 = stencil s17 cov2_1
    s18 = [92113,183922]
