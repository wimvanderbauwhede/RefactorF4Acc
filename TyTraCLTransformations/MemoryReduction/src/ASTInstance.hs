...
ast = [
       ...
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu6_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s12")) (Vec VT (Scalar VDC DFloat "diu6_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu5_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s13")) (Vec VT (Scalar VDC DFloat "diu5_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov4_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s14")) (Vec VT (Scalar VDC DFloat "cov4_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu2_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s15")) (Vec VT (Scalar VDC DFloat "diu2_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov2_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s16")) (Vec VT (Scalar VDC DFloat "cov2_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov5_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s17")) (Vec VT (Scalar VDC DFloat "cov5_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu4_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s18")) (Vec VT (Scalar VDC DFloat "diu4_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov6_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s19")) (Vec VT (Scalar VDC DFloat "cov6_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov9_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s20")) (Vec VT (Scalar VDC DFloat "cov9_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu7_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s21")) (Vec VT (Scalar VDC DFloat "diu7_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu8_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s22")) (Vec VT (Scalar VDC DFloat "diu8_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu1_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s23")) (Vec VT (Scalar VDC DFloat "diu1_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov3_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s24")) (Vec VT (Scalar VDC DFloat "cov3_1")))
       ,( (Tuple [Vec VT (Scalar VDC DFloat "dfu1_1"),Vec VT (Scalar VDC DFloat "dfv1_1"),Vec VT (Scalar VDC DFloat "dfw1_1"),Vec VT (Scalar VDC DFloat "f_1"),Vec VT (Scalar VDC DFloat "g_1"),Vec VT (Scalar VDC DFloat "h_1")]), UnzipT ( Map (Function "velfg_map_218"  [SVec 153 (Scalar VDC DFloat "dx1_0"),SVec 152 (Scalar VDC DFloat "dy1_0"),SVec 94 (Scalar VDC DFloat "dzn_0"),SVec 94 (Scalar VDC DFloat "dzs_0")]) (ZipT [Vec VS (SVec 2 (Scalar VDC DFloat "cov1_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov2_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov3_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu1_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu2_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu3_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov4_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov5_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov6_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu4_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu5_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu6_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov7_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov8_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "cov9_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu7_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu8_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "diu9_s_0"))]) ) )
        -- les_map_87
       ,(Vec VS (SVec 4 (Scalar VDC DFloat "diu7_s_1" )) , Stencil (SVec 4 (Scalar VDC DInt "s25")) (Vec VT (Scalar VDC DFloat "diu7_1")))
       ,(Vec VS (SVec 4 (Scalar VDC DFloat "diu3_s_1" )) , Stencil (SVec 4 (Scalar VDC DInt "s26")) (Vec VT (Scalar VDC DFloat "diu3_1")))
       ,(Vec VS (SVec 4 (Scalar VDC DFloat "diu6_s_1" )) , Stencil (SVec 4 (Scalar VDC DInt "s27")) (Vec VT (Scalar VDC DFloat "diu6_1")))
       ,(Vec VS (SVec 4 (Scalar VDC DFloat "diu8_s_1" )) , Stencil (SVec 4 (Scalar VDC DInt "s28")) (Vec VT (Scalar VDC DFloat "diu8_1")))
       ,(Vec VS (SVec 4 (Scalar VDC DFloat "diu2_s_1" )) , Stencil (SVec 4 (Scalar VDC DInt "s29")) (Vec VT (Scalar VDC DFloat "diu2_1")))
       ,(Vec VS (SVec 4 (Scalar VDC DFloat "diu4_s_1" )) , Stencil (SVec 4 (Scalar VDC DInt "s30")) (Vec VT (Scalar VDC DFloat "diu4_1")))
       ,( Vec VT (Scalar VDC DFloat "sm_1"), Map (Function "les_map_87"  [SVec 90 (Scalar VDC DFloat "delx1_0")]) (ZipT [Vec VT (Scalar VDC DFloat "diu1_1"),Vec VS (SVec 4 (Scalar VDC DFloat "diu2_s_1")),Vec VS (SVec 4 (Scalar VDC DFloat "diu3_s_1")),Vec VS (SVec 4 (Scalar VDC DFloat "diu4_s_1")),Vec VT (Scalar VDC DFloat "diu5_1"),Vec VS (SVec 4 (Scalar VDC DFloat "diu6_s_1")),Vec VS (SVec 4 (Scalar VDC DFloat "diu7_s_1")),Vec VS (SVec 4 (Scalar VDC DFloat "diu8_s_1")),Vec VT (Scalar VDC DFloat "diu9_1")]) )
        -- les_map_107
       ,(Vec VS (SVec 3 (Scalar VDC DFloat "diu8_s_2" )) , Stencil (SVec 3 (Scalar VDC DInt "s31")) (Vec VT (Scalar VDC DFloat "diu8_1")))
       ,(Vec VS (SVec 3 (Scalar VDC DFloat "diu2_s_2" )) , Stencil (SVec 3 (Scalar VDC DInt "s32")) (Vec VT (Scalar VDC DFloat "diu2_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu1_s_1" )) , Stencil (SVec 2 (Scalar VDC DInt "s33")) (Vec VT (Scalar VDC DFloat "diu1_1")))
       ,(Vec VS (SVec 3 (Scalar VDC DFloat "diu6_s_2" )) , Stencil (SVec 3 (Scalar VDC DInt "s34")) (Vec VT (Scalar VDC DFloat "diu6_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu5_s_1" )) , Stencil (SVec 2 (Scalar VDC DInt "s35")) (Vec VT (Scalar VDC DFloat "diu5_1")))
       ,(Vec VS (SVec 3 (Scalar VDC DFloat "diu7_s_2" )) , Stencil (SVec 3 (Scalar VDC DInt "s36")) (Vec VT (Scalar VDC DFloat "diu7_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu9_s_1" )) , Stencil (SVec 2 (Scalar VDC DInt "s37")) (Vec VT (Scalar VDC DFloat "diu9_1")))
       ,(Vec VS (SVec 3 (Scalar VDC DFloat "diu4_s_2" )) , Stencil (SVec 3 (Scalar VDC DInt "s38")) (Vec VT (Scalar VDC DFloat "diu4_1")))
       ,(Vec VS (SVec 3 (Scalar VDC DFloat "diu3_s_2" )) , Stencil (SVec 3 (Scalar VDC DInt "s39")) (Vec VT (Scalar VDC DFloat "diu3_1")))
       ,(Vec VS (SVec 15 (Scalar VDC DFloat "sm_s_0" )) , Stencil (SVec 15 (Scalar VDC DInt "s40")) (Vec VT (Scalar VDC DFloat "sm_1")))
...
functionSignaturesList = [
        ...
        ("velfg_map_133",  [Tuple [SVec 94 (Scalar VDC DFloat "dzn_0"),SVec 153 (Scalar VDC DFloat "dx1_0"),SVec 152 (Scalar VDC DFloat "dy1_0")],Tuple [SVec 2 (Scalar VDC DFloat "u_s_1"),SVec 3 (Scalar VDC DFloat "w_s_1"),SVec 2 (Scalar VDC DFloat "v_s_1")],Tuple [Scalar VT DFloat "cov7_1",Scalar VT DFloat "cov8_1",Scalar VT DFloat "diu7_1",Scalar VT DFloat "diu8_1",Scalar VT DFloat "nou7_1",Scalar VT DFloat "nou8_1"]]),
...
stencilDefinitionsList = [("s1" , [305,23409,23560,23561,23712] ), ("s2" , [305,23409,23410,23560,23561] ), ("s3" , [23561,23562,23713,46817] ), ("s4" , [46665,46816,46817] ), ("s5" , [23560,46816] ), ("s6" , [23409,46665] ), ("s7" , [23563,46972] ), ("s8" , [23718,23719] ), ("s9" , [23563,23716] ), ("s10" , [23563,46972] ), ("s11" , [23563,23564] ), ("s12" , [23563,46972] ), ("s13" , [23718,23872] ), ("s14" , [23563,23564] ), ("s15" , [23563,23716] ), ("s16" , [23563,23716] ), ("s17" , [23718,23872] ), ("s18" , [23563,23564] ), ("s19" , [23563,46972] ), ("s20" , [23563,46972] ), ("s21" , [23563,23564] ), ("s22" , [23563,23716] ), ("s23" , [23718,23719] ), ("s24" , [23563,46972] ), ("s25" , [154,155,23563,23564] ), ("s26" , [23562,23563,46971,46972] ), ("s27" , [23410,23563,46819,46972] ), ("s28" , [154,307,23563,23716] ), ("s29" , [23562,23563,23715,23716] ), ("s30" , [23410,23411,23563,23564] ), ("s31" , [307,23563,23716] ), ("s32" , [23563,23715,23716] ), ("s33" , [23718,23719] ), ("s34" , [23563,46819,46972] ), ("s35" , [23718,23872] ), ("s36" , [155,23563,23564] ), ("s37" , [23563,46972] ), ("s38" , [23411,23563,23564] ), ("s39" , [23563,46971,46972] ), ("s40" , [308,309,23564,23565,23716,23717,23718,23869,23870,23871,46973,47125,47126,47127,47279] )]
...
mainArgDeclsList = [
    ...
    , ("delx1_0" , MkFDecl "real"  (Just [90]) (Just In) ["delx1_0"] )
...
main :: (Vec 2139552 Float,Vec 2139552 Float,Vec 2162808 Float,SVec 153 Float,SVec 152 Float,SVec 94 Float,SVec 94 Float,SVec 90 Float) -> (Vec 2074891 Float,Vec 2074891 Float,Vec 2074891 Float)
main (u_0,v_0,w_0,dx1_0,dy1_0,dzn_0,dzs_0,delx1_0) =
  let
     -- velfg_map_76
    ...
    (cov7_1,cov8_1,diu7_1,diu8_1,nou7_1,nou8_1) = unzipt $ map (velfg_map_133 (dzn_0,dx1_0,dy1_0)) (zipt (u_s_1,w_s_1,v_s_1))
     -- velfg_map_218
    s7 = [23563,46972]
    diu3_s_0 = stencil s7 diu3_1
    s8 = [23718,23719]
    cov1_s_0 = stencil s8 cov1_1
    s9 = [23563,23716]
    cov8_s_0 = stencil s9 cov8_1
    s10 = [23563,46972]
    diu9_s_0 = stencil s10 diu9_1
    s11 = [23563,23564]
    cov7_s_0 = stencil s11 cov7_1
    s12 = [23563,46972]
    diu6_s_0 = stencil s12 diu6_1
    s13 = [23718,23872]
    diu5_s_0 = stencil s13 diu5_1
    s14 = [23563,23564]
    cov4_s_0 = stencil s14 cov4_1
    s15 = [23563,23716]
    diu2_s_0 = stencil s15 diu2_1
    s16 = [23563,23716]
    cov2_s_0 = stencil s16 cov2_1
    s17 = [23718,23872]
    ...
    s22 = [23563,23716]
    diu8_s_0 = stencil s22 diu8_1
    s23 = [23718,23719]
    diu1_s_0 = stencil s23 diu1_1
    s24 = [23563,46972]
    ...
    (dfu1_1,dfv1_1,dfw1_1,f_1,g_1,h_1) = unzipt $ map (velfg_map_218 (dx1_0,dy1_0,dzn_0,dzs_0)) (zipt (cov1_s_0,cov2_s_0,cov3_s_0,diu1_s_0,diu2_s_0,diu3_s_0,cov4_s_0,cov5_s_0,cov6_s_0,diu4_s_0,diu5_s_0,diu6_s_0,cov7_s_0,cov8_s_0,cov9_s_0,diu7_s_0,diu8_s_0,diu9_s_0))
     -- les_map_87
    s25 = [154,155,23563,23564]
    diu7_s_1 = stencil s25 diu7_1
    s26 = [23562,23563,46971,46972]
    diu3_s_1 = stencil s26 diu3_1
    s27 = [23410,23563,46819,46972]
    diu6_s_1 = stencil s27 diu6_1
    s28 = [154,307,23563,23716]
    diu8_s_1 = stencil s28 diu8_1
    s29 = [23562,23563,23715,23716]
    diu2_s_1 = stencil s29 diu2_1
    s30 = [23410,23411,23563,23564]
    diu4_s_1 = stencil s30 diu4_1
    sm_1 =  map (les_map_87 delx1_0) (zipt (diu1_1,diu2_s_1,diu3_s_1,diu4_s_1,diu5_1,diu6_s_1,diu7_s_1,diu8_s_1,diu9_1))
     -- les_map_107
    s31 = [307,23563,23716]
    diu8_s_2 = stencil s31 diu8_1
    s32 = [23563,23715,23716]
    diu2_s_2 = stencil s32 diu2_1
    s33 = [23718,23719]
    diu1_s_1 = stencil s33 diu1_1
    s34 = [23563,46819,46972]
    diu6_s_2 = stencil s34 diu6_1
    s35 = [23718,23872]
    diu5_s_1 = stencil s35 diu5_1
    s36 = [155,23563,23564]
    diu7_s_2 = stencil s36 diu7_1
    s37 = [23563,46972]
    diu9_s_1 = stencil s37 diu9_1
    s38 = [23411,23563,23564]
    diu4_s_2 = stencil s38 diu4_1
    s39 = [23563,46971,46972]
    diu3_s_2 = stencil s39 diu3_1
    s40 = [308,309,23564,23565,23716,23717,23718,23869,23870,23871,46973,47125,47126,47127,47279]
    sm_s_0 = stencil s40 sm_1
