...
ast = [
       ...
       ,( (Tuple [Vec VO (Scalar VDC DFloat "un_1"),Vec VO (Scalar VDC DFloat "vn_1")]), UnzipT ( Map (Function "dyn_shapiro_map_55" []) (ZipT [Vec VI (Scalar VDC DFloat "u_0"),Vec VT (Scalar VDC DFloat "du___dyn_1"),Vec VS (SVec 3 (Scalar VDC DInt "wet_s_0")),Vec VI (Scalar VDC DFloat "v_0"),Vec VT (Scalar VDC DFloat "dv___dyn_1")]) ) )
        -- dyn_shapiro_map_75
       ,(Vec VS (SVec 5 (Scalar VDC DFloat "h_s_0" )) , Stencil (SVec 5 (Scalar VDC DInt "s3")) (Vec VI (Scalar VDC DFloat "h_0")))
       ...
       ,( Vec VT (Scalar VDC DFloat "etan_1"), Map (Function "dyn_shapiro_map_75" []) (ZipT [Vec VS (SVec 2 (Scalar VDC DFloat "un_s_0")),Vec VS (SVec 5 (Scalar VDC DFloat "h_s_0")),Vec VS (SVec 2 (Scalar VDC DFloat "vn_s_0")),Vec VI (Scalar VDC DFloat "eta_0")]) )
        -- dyn_shapiro_map_92
       ,(Vec VS (SVec 5 (Scalar VDC DFloat "etan_s_0" )) , Stencil (SVec 5 (Scalar VDC DInt "s3")) (Vec VT (Scalar VDC DFloat "etan_1")))
       ,(Vec VS (SVec 5 (Scalar VDC DInt "wet_s_1" )) , Stencil (SVec 5 (Scalar VDC DInt "s3")) (Vec VI (Scalar VDC DInt "wet_0")))
       ,( Vec VO (Scalar VDC DFloat "etann_1"), Map (Function "dyn_shapiro_map_92" []) (ZipT [Vec VS (SVec 5 (Scalar VDC DInt "wet_s_1")),Vec VS (SVec 5 (Scalar VDC DFloat "etan_s_0"))]) )
        ]
...
functionSignaturesList = [
        ...
        ("dyn_shapiro_map_75",  [Tuple [],Tuple [SVec 2 (Scalar VDC DFloat "un_s_0"),SVec 5 (Scalar VDC DFloat "h_s_0"),SVec 2 (Scalar VDC DFloat "vn_s_0"),Scalar VI DFloat "eta_0"],Scalar VT DFloat "etan_1"]),
        ("dyn_shapiro_map_92",  [Tuple [],Tuple [SVec 5 (Scalar VDC DInt "wet_s_1"),SVec 5 (Scalar VDC DFloat "etan_s_0")],Scalar VO DFloat "etann_1"])
    ]
stencilDefinitionsList = [("s1" , [503,504,1005] ), ("s3" , [1,502,503,504,1005] ), ("s4" , [502,503] ), ("s5" , [1,503] )]

mainArgDeclsList = [
      ("h_0" , MkFDecl "real"  (Just [(1,252004)]) (Just In) ["h_0"] )
    , ("v_0" , MkFDecl "real"  (Just [(1,252004)]) (Just In) ["v_0"] )
    , ("eta_0" , MkFDecl "real"  (Just [(1,252004)]) (Just In) ["eta_0"] )
    , ("u_0" , MkFDecl "real"  (Just [(1,252004)]) (Just In) ["u_0"] )
    , ("wet_0" , MkFDecl "integer"  (Just [(1,252004)]) (Just In) ["wet_0"] )
    , ("un_1" , MkFDecl "real"  (Just [(1,252004)]) (Just Out) ["un_1"] )
    , ("etann_1" , MkFDecl "real"  (Just [(1,252004)]) (Just Out) ["etann_1"] )
    , ("vn_1" , MkFDecl "real"  (Just [(1,252004)]) (Just Out) ["vn_1"] )
  ]
...
scalarisedArgsList = [
    ...
    ,( "dyn_shapiro_map_75",[("un",(1,In,"real")), ("un",(2,In,"real")), ("h",(1,In,"real")), ("h",(2,In,"real")), ("h",(3,In,"real")), ("h",(4,In,"real")), ("h",(5,In,"real")), ("vn",(1,In,"real")), ("vn",(2,In,"real")), ("eta",(0,In,"real")), ("etan",(0,Out,"real"))])
    ,( "dyn_shapiro_map_92",[("wet",(1,In,"integer")), ("wet",(2,In,"integer")), ("wet",(3,In,"integer")), ("wet",(4,In,"integer")), ("wet",(5,In,"integer")), ("etan",(1,In,"real")), ("etan",(2,In,"real")), ("etan",(3,In,"real")), ("etan",(4,In,"real")), ("etan",(5,In,"real")), ("etann",(0,Out,"real"))])
  ]
...
origNamesList = [
    ...
    ,( "dyn_shapiro_map_75",[("un",[("un_s_0",In)]), ("h",[("h_s_0",In)]), ("vn",[("vn_s_0",In)]), ("eta",[("eta_0",In)]), ("etan",[("etan_1",Out)])])
    ,( "dyn_shapiro_map_92",[("wet",[("wet_s_1",In)]), ("etan",[("etan_s_0",In)]), ("etann",[("etann_1",Out)])])
  ]
...
dyn_shapiro_map_92 :: (SVec 5 Int,SVec 5 Float) -> Float
dyn_shapiro_map_75 :: (SVec 2 Float,SVec 5 Float,SVec 2 Float,Float) -> Float
