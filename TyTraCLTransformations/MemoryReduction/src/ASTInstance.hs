...
scalarisedArgsList = [
    ...
    ,( "shapiro_dyn_update_superkernel",[("wet",(0,InOut,"integer")), ("eps",(0,In,"real")), ("eta",(0,In,"real")), ("dt",(0,In,"real")), ("g",(0,In,"real")), ("dx",(0,In,"real")), ("dy",(0,In,"real")), ("du",(0,Out,"real")), ("dv",(0,Out,"real")), ("u",(0,InOut,"real")), ("v",(0,InOut,"real")), ("h",(0,InOut,"real")), ("hzero",(0,In,"real")), ("hmin",(0,In,"real")), ("state_ptr",(0,In,"integer"))])
