...
main :: (Vec 252004 Float,Vec 252004 Int,Vec 252004 Float,Vec 252004 Float,Vec 252004 Float,Float) -> (Vec 252004 Float,Vec 252004 Float,Vec 252004 Float)
main (eta_0,wet_0,u_0,v_0,h_0,eps_0) =
  let
     -- dyn_shapiro_map_49
    s1 = [503,504,1005]
