...
ast = [
        ...
        ,( Vec VO DFloat "eta_1", Map (Function "shapiro_map_16"  [Scalar VI DFloat  "eps_0"]) (ZipT [Vec VS (DSVec 5 DInt) "wet_s_0",Vec VS (DSVec 5 DFloat) "etan_s_0"]) )
         -- dyn_map_39
        ,(Vec VS (DSVec 5 DFloat) "h_s_0" , Stencil (SVec 5 DInt "s3") (Vec VI DFloat "h_0"))
        ,(Vec VS (DSVec 2 DFloat) "un_s_0" , Stencil (SVec 2 DInt "s4") (Vec VI DFloat "un_0"))
        ,(Vec VS (DSVec 3 DFloat) "eta_s_0" , Stencil (SVec 3 DInt "s5") (Vec VO DFloat "eta_1"))
        ,(Vec VS (DSVec 3 DInt) "wet_s_1" , Stencil (SVec 3 DInt "s6") (Vec VI DInt "wet_0"))
        ,(Vec VS (DSVec 2 DFloat) "vn_s_0" , Stencil (SVec 2 DInt "s7") (Vec VI DFloat "vn_0"))
...
stencilDefinitionsList = [("s1" , [-502,-1,0,1,502] ), ("s2" , [-502,-1,0,1,502] ), ("s3" , [-502,-1,0,1,502] ), ("s4" , [-502,0] ), ("s5" , [0,1,502] ), ("s6" , [0,1,502] ), ("s7" , [-1,0] )]
mainArgDeclsList = [
