...
ast = [
       ...
       ,( (Tuple [Vec VT (Scalar VDC DFloat "cov1_1"),Vec VT (Scalar VDC DFloat "cov2_1"),Vec VT (Scalar VDC DFloat "cov3_1"),Vec VT (Scalar VDC DFloat "cov4_1"),Vec VT (Scalar VDC DFloat "cov5_1"),Vec VT (Scalar VDC DFloat "cov6_1"),Vec VT (Scalar VDC DFloat "cov9_1"),Vec VT (Scalar VDC DFloat "diu1_1"),Vec VT (Scalar VDC DFloat "diu2_1"),Vec VT (Scalar VDC DFloat "diu3_1"),Vec VT (Scalar VDC DFloat "diu4_1"),Vec VT (Scalar VDC DFloat "diu5_1"),Vec VT (Scalar VDC DFloat "diu6_1"),Vec VT (Scalar VDC DFloat "diu9_1"),Vec VT (Scalar VDC DFloat "nou1_1"),Vec VT (Scalar VDC DFloat "nou2_1"),Vec VT (Scalar VDC DFloat "nou3_1"),Vec VT (Scalar VDC DFloat "nou4_1"),Vec VT (Scalar VDC DFloat "nou5_1"),Vec VT (Scalar VDC DFloat "nou6_1"),Vec VT (Scalar VDC DFloat "nou9_1")]), UnzipT ( Map (Function "velfg_map_76"  [FVec [(-1,301)] (Scalar VDC DFloat "dx1_0"),FVec [(0,301)] (Scalar VDC DFloat "dy1_0"),FVec [(-1,92)] (Scalar VDC DFloat "dzn_0"),FVec [(-1,92)] (Scalar VDC DFloat "dzs_0"),Scalar VT DInt "global_id_0"]) (ZipT [Vec VS (SVec 5 (Scalar VDC DFloat "u_s_0")),Vec VS (SVec 5 (Scalar VDC DFloat "v_s_0")),Vec VS (SVec 4 (Scalar VDC DFloat "w_s_0"))]) ) )
        -- velfg_map_133
       ...
       ,( (Tuple [Vec VT (Scalar VDC DFloat "cov7_1"),Vec VT (Scalar VDC DFloat "cov8_1"),Vec VT (Scalar VDC DFloat "diu7_1"),Vec VT (Scalar VDC DFloat "diu8_1"),Vec VT (Scalar VDC DFloat "nou7_1"),Vec VT (Scalar VDC DFloat "nou8_1")]), UnzipT ( Map (Function "velfg_map_133"  [FVec [(-1,92)] (Scalar VDC DFloat "dzn_0"),FVec [(-1,301)] (Scalar VDC DFloat "dx1_0"),FVec [(0,301)] (Scalar VDC DFloat "dy1_0"),Scalar VT DInt "global_id_0"]) (ZipT [Vec VS (SVec 2 (Scalar VDC DFloat "u_s_1")),Vec VS (SVec 3 (Scalar VDC DFloat "w_s_1")),Vec VS (SVec 2 (Scalar VDC DFloat "v_s_1"))]) ) )
        -- velfg_map_218
       ...
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu2_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s12")) (Vec VT (Scalar VDC DFloat "diu2_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu8_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s12")) (Vec VT (Scalar VDC DFloat "diu8_1")))
       ...
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov8_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s12")) (Vec VT (Scalar VDC DFloat "cov8_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov6_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s7")) (Vec VT (Scalar VDC DFloat "cov6_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov2_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s12")) (Vec VT (Scalar VDC DFloat "cov2_1")))
...
main :: (Vec 8510058 Float,Vec 8418552 Float,Vec 8418552 Float,FVec [(-1,301)] Float,FVec [(0,301)] Float,FVec [(-1,92)] Float,FVec [(-1,92)] Float) -> (Vec 8244691 Float,Vec 8244691 Float,Vec 8244691 Float)
main (w_0,v_0,u_0,dx1_0,dy1_0,dzn_0,dzs_0) =
  let
    ...
    (cov7_1,cov8_1,diu7_1,diu8_1,nou7_1,nou8_1) = unzipt $ map (velfg_map_133 (dzn_0,dx1_0,dy1_0,global_id_0)) (zipt (u_s_1,w_s_1,v_s_1))
     -- velfg_map_218
    s7 = [92113,183922]
    cov3_s_0 = stencil s7 cov3_1
    s8 = [92418,92419]
    diu1_s_0 = stencil s8 diu1_1
    s9 = [92113,92114]
    diu4_s_0 = stencil s9 diu4_1
    s10 = [92418,92722]
    diu5_s_0 = stencil s10 diu5_1
    s11 = [92113,183922]
    diu6_s_0 = stencil s11 diu6_1
    s12 = [92113,92416]
    diu2_s_0 = stencil s12 diu2_1
    s13 = [92113,92416]
    diu8_s_0 = stencil s13 diu8_1
    s14 = [92113,183922]
    cov9_s_0 = stencil s14 cov9_1
    s15 = [92113,92114]
    diu7_s_0 = stencil s15 diu7_1
    s16 = [92113,92114]
    cov7_s_0 = stencil s16 cov7_1
    s17 = [92113,183922]
    diu9_s_0 = stencil s17 diu9_1
    s18 = [92113,92416]
    cov8_s_0 = stencil s18 cov8_1
    s19 = [92113,183922]
    cov6_s_0 = stencil s19 cov6_1
    s20 = [92113,92416]
    cov2_s_0 = stencil s20 cov2_1
    s21 = [92418,92722]
    cov5_s_0 = stencil s21 cov5_1
    s22 = [92113,92114]
    cov4_s_0 = stencil s22 cov4_1
    s23 = [92418,92419]
