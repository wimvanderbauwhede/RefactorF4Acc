...
! ---- BEGIN dyn_shapiro_map_49 -----------------------------------------------------------------------------------------------
oclGlobalRange = (500 * 500)
oclLocalRange = 0
state_ptr(1) = ST_DYN_SHAPIRO_MAP_49
...
! call dyn_shapiro_map_49

! ---- END --------------------------------------------------------------------------------------------------------------------
! ---- BEGIN dyn_shapiro_map_55 -----------------------------------------------------------------------------------------------
oclGlobalRange = (500 * 500)
oclLocalRange = 0
state_ptr(1) = ST_DYN_SHAPIRO_MAP_55

state_ptr_ptr(1) = state_ptr
call oclWrite1DIntArrayBuffer(state_ptr_buf,state_ptr_ptr_sz,state_ptr_ptr)! Automatic conversion to array
call runOcl(oclGlobalRange,oclLocalRange,exectime)
! call dyn_shapiro_map_55

! ---- END --------------------------------------------------------------------------------------------------------------------
! ---- BEGIN dyn_shapiro_map_75 -----------------------------------------------------------------------------------------------
oclGlobalRange = (500 * 500)
oclLocalRange = 0
state_ptr(1) = ST_DYN_SHAPIRO_MAP_75

state_ptr_ptr(1) = state_ptr
call oclWrite1DIntArrayBuffer(state_ptr_buf,state_ptr_ptr_sz,state_ptr_ptr)! Automatic conversion to array
call runOcl(oclGlobalRange,oclLocalRange,exectime)
! call dyn_shapiro_map_75

! ---- END --------------------------------------------------------------------------------------------------------------------
! ---- BEGIN dyn_shapiro_map_92 -----------------------------------------------------------------------------------------------
oclGlobalRange = (500 * 500)
oclLocalRange = 0
state_ptr(1) = ST_DYN_SHAPIRO_MAP_92

state_ptr_ptr(1) = state_ptr
call oclWrite1DIntArrayBuffer(state_ptr_buf,state_ptr_ptr_sz,state_ptr_ptr)! Automatic conversion to array
call runOcl(oclGlobalRange,oclLocalRange,exectime)
! call dyn_shapiro_map_92
