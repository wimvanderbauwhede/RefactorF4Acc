module module_dyn_shapiro_update_superkernel_init
...
integer, parameter :: ST_DYN_SHAPIRO_UPDATE_MAP_104 = 4 !  dyn_shapiro_update_map_104
        ...
        integer, parameter ::HZERO_BUF_IDX = 17
...
! WV 2021-06-22
    ...
    subroutine dyn_shapiro_update_superkernel_init()

        use oclWrapper
        character(len=*), parameter :: srcstr = "module_dyn_shapiro_update_superkernel.cl"
        character(len=*), parameter :: kstr   = "dyn_shapiro_update_superkernel"
! parameters
...
! buffer declarations
        ...
        call oclSetFloatArrayArg(16, hzero_buf)
    ...
    end subroutine dyn_shapiro_update_superkernel_init
end module module_dyn_shapiro_update_superkernel_init