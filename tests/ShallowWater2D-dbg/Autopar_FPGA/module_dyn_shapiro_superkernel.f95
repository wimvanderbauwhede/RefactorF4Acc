...
subroutine dyn_shapiro_map_55(u,du___dyn,wet,duu___dyn,v,dv___dyn,un,vn)
...
subroutine dyn_shapiro_map_92(wet,eps,etan,eta)
...
subroutine dyn_shapiro_superkernel(dt,g,eta,dx,dy,du___dyn,dv___dyn,u,wet,duu___dyn,v,un,vn,h,etan,eps,state_ptr)
...
! SUPERKERNEL BODY
  select case(state)
    ...
    case (ST_DYN_SHAPIRO_MAP_55)
      call dyn_shapiro_map_55(u,du___dyn,wet,duu___dyn,v,dv___dyn,un,vn)
    case (ST_DYN_SHAPIRO_MAP_75)
      call dyn_shapiro_map_75(un,h,vn,eta,dt,dx,dy,etan)
    case (ST_DYN_SHAPIRO_MAP_92)
      call dyn_shapiro_map_92(wet,eps,etan,eta)
  end select
