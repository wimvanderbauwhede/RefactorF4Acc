...
subroutine dyn_shapiro_update_map_49(dt,g,eta,dx,dy,du___dyn,dv___dyn)
...
subroutine dyn_shapiro_update_map_55(u,du___dyn,wet,duu___dyn,v,dv___dyn,un,vn)
...
subroutine dyn_shapiro_update_map_75(un,h,vn,eta,dt,dx,dy,etan)
...
subroutine dyn_shapiro_update_map_92(wet,eps,etan,eta)
...
subroutine dyn_shapiro_update_map_104(hzero,eta,h)
...
subroutine dyn_shapiro_update_superkernel(dt,g,eta,dx,dy,du___dyn,dv___dyn,u,wet,duu___dyn,v,un,vn,h,etan,eps,hzero,state_ptr)
! use module_dyn_shapiro_update_superkernel_init
  ...
  integer :: state
  integer :: state_ptr
integer, parameter :: ST_DYN_SHAPIRO_UPDATE_MAP_49 = 0 !  dyn_shapiro_update_map_49
integer, parameter :: ST_DYN_SHAPIRO_UPDATE_MAP_55 = 1 !  dyn_shapiro_update_map_55
integer, parameter :: ST_DYN_SHAPIRO_UPDATE_MAP_75 = 2 !  dyn_shapiro_update_map_75
integer, parameter :: ST_DYN_SHAPIRO_UPDATE_MAP_92 = 3 !  dyn_shapiro_update_map_92
integer, parameter :: ST_DYN_SHAPIRO_UPDATE_MAP_104 = 4 !  dyn_shapiro_update_map_104
  state = state_ptr ! state 
! SUPERKERNEL BODY
  select case(state)
    case (ST_DYN_SHAPIRO_UPDATE_MAP_49)
      call dyn_shapiro_update_map_49(dt,g,eta,dx,dy,du___dyn,dv___dyn)
    case (ST_DYN_SHAPIRO_UPDATE_MAP_55)
      call dyn_shapiro_update_map_55(u,du___dyn,wet,duu___dyn,v,dv___dyn,un,vn)
    case (ST_DYN_SHAPIRO_UPDATE_MAP_75)
      call dyn_shapiro_update_map_75(un,h,vn,eta,dt,dx,dy,etan)
    case (ST_DYN_SHAPIRO_UPDATE_MAP_92)
      call dyn_shapiro_update_map_92(wet,eps,etan,eta)
    case (ST_DYN_SHAPIRO_UPDATE_MAP_104)
      call dyn_shapiro_update_map_104(hzero,eta,h)
  end select
