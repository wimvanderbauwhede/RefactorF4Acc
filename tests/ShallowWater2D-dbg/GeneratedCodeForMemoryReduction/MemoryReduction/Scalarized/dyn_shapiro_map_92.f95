module singleton_module_dyn_shapiro_map_92

contains

subroutine dyn_shapiro_map_92_scal(wet_j_km1,wet_jm1_k,wet_j_k,wet_jp1_k,wet_j_kp1,eps,etan_j_km1, &
      etan_jm1_k,etan_j_k,etan_jp1_k,etan_j_kp1,etann_j_k)
...
!    ! ParallelFortran: Original code
 ...
 etann_j_k = term1___shapiro + term2___shapiro + term3___shapiro
else
 etann_j_k = etan_j_k
end if
end subroutine dyn_shapiro_map_92_scal

end module singleton_module_dyn_shapiro_map_92
