...
C                                                                       00020011
C      FM091  WV MODIFIED FROM FM011, remove space to make sane         00030011
C                                                                       00040011
...
C        SECTION 3.1.6, BLANK CHARACTER                                 00120011
      DIMENSION  IADN11(3),IADN12(3)                                    00130011
      INTEGER  RVTNI1                                                   00140011
      REAL   IVTNR1                                                     00150011
      LOGICAL   LVTNL1,LVTNL2                                           00160011
      COMMON  IACE11(3)                                                 00170011
      EQUIVALENCE  (IACE11(1),IADN11(1))                                00180011
      DATA   IADN12/3*3/                                                00190011
C                                                                       00200011
C      **********************************************************       00210011
C                                                                       00220011
...
41030 IF  (IADN11(2) - 2)  21030,11030,21030                            01070011
...
C                                                                       02910011
90007 FORMAT (" ",20X,"END OF PROGRAM FM091" )                          02920011
      END                                                               02930011
