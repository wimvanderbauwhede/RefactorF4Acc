...
90001 FORMAT (" ",56X,"FM719")                                          04130719
90000 FORMAT (" ",50X,"END OF PROGRAM FM719" )                          04140719
CBB** ********************** BBCFMT0A **********************************04150719
C**** FORMATS FOR TEST DETAIL LINES                                     04160719
C****                                                                   04170719
80000 FORMAT (" ",2X,I3,4X,"DELETED",32X,A31)                           04180719
80002 FORMAT (" ",2X,I3,4X," PASS  ",32X,A31)                           04190719
80004 FORMAT (" ",2X,I3,4X,"INSPECT",32X,A31)                           04200719
80008 FORMAT (" ",2X,I3,4X," FAIL  ",32X,A31)                           04210719
80010 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",15X,"COMPUTED= " ,           04220719
     1I6,/," ",15X,"CORRECT=  " ,I6)                                    04230719
80012 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           04240719
     1E12.5,/," ",16X,"CORRECT=  " ,E12.5)                              04250719
80018 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           04260719
     1A21,/," ",16X,"CORRECT=  " ,A21)                                  04270719
80020 FORMAT (" ",16X,"COMPUTED= " ,A21,1X,A31)                         04280719
80022 FORMAT (" ",16X,"CORRECT=  " ,A21,1X,A31)                         04290719
80024 FORMAT (" ",16X,"COMPUTED= " ,I6,16X,A31)                         04300719
80026 FORMAT (" ",16X,"CORRECT=  " ,I6,16X,A31)                         04310719
80028 FORMAT (" ",16X,"COMPUTED= " ,E12.5,10X,A31)                      04320719
80030 FORMAT (" ",16X,"CORRECT=  " ,E12.5,10X,A31)                      04330719
80050 FORMAT (" ",48X,A31)                                              04340719
CBE** ********************** BBCFMT0A **********************************04350719
CBB** ********************** BBCFMAT1 **********************************04360719
C**** FORMATS FOR TEST DETAIL LINES - FULL LANGUAGE                     04370719
C****                                                                   04380719
80031 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           04390719
     1D17.10,/," ",16X,"CORRECT=  " ,D17.10)                            04400719
80033 FORMAT (" ",16X,"COMPUTED= " ,D17.10,10X,A31)                     04410719
80035 FORMAT (" ",16X,"CORRECT=  " ,D17.10,10X,A31)                     04420719
80037 FORMAT (" ",16X,"COMPUTED= " ,"(",E12.5,", ",E12.5,")",6X,A31)    04430719
80039 FORMAT (" ",16X,"CORRECT=  " ,"(",E12.5,", ",E12.5,")",6X,A31)    04440719
80041 FORMAT (" ",16X,"COMPUTED= " ,"(",F12.5,", ",F12.5,")",6X,A31)    04450719
80043 FORMAT (" ",16X,"CORRECT=  " ,"(",F12.5,", ",F12.5,")",6X,A31)    04460719
80045 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           04470719
     1"(",F12.5,", ",F12.5,")"/," ",16X,"CORRECT=  " ,                  04480719
     2"(",F12.5,", ",F12.5,")")                                         04490719
CBE** ********************** BBCFMAT1 **********************************04500719
CBB** ********************** BBCFMT0B **********************************04510719
C**** FORMAT STATEMENTS FOR PAGE HEADERS                                04520719
C****                                                                   04530719
90002 FORMAT ("1")                                                      04540719
90004 FORMAT (" ")                                                      04550719
90006 FORMAT (" ",20X,"NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY" )04560719
90007 FORMAT (" ",19X,"FORTRAN COMPILER VALIDATION SYSTEM" )            04570719
90008 FORMAT (" ",21X,A13,A17)                                          04580719
90009 FORMAT (" ",/," *",A5,"BEGIN*",12X,"TEST RESULTS - " ,A5,/)       04590719
90010 FORMAT (" ",8X,"TEST DATE*TIME= " ,A17,"  -  COMPILER= " ,A20)    04600719
90013 FORMAT (" "," TEST   ","PASS/FAIL " ,6X,"DISPLAYED RESULTS" ,     04610719
     1       7X,"REMARKS",24X)                                          04620719
90014 FORMAT (" ","----------------------------------------------" ,    04630719
     1        "---------------------------------" )                     04640719
90015 FORMAT (" ",48X,"THIS PROGRAM HAS " ,I3," TESTS",/)               04650719
C****                                                                   04660719
C**** FORMAT STATEMENTS FOR REPORT FOOTINGS                             04670719
C****                                                                   04680719
90016 FORMAT (" ",/," *",A5,"END*",14X,"END OF TEST - " ,A5,/)          04690719
90018 FORMAT (" ",A13,13X,A20,"   *   ",A10,"/",                        04700719
     1        A13)                                                      04710719
90019 FORMAT (" ","FOR OFFICIAL USE ONLY     " ,35X,"COPYRIGHT  1982" ) 04720719
C****                                                                   04730719
C**** FORMAT STATEMENTS FOR RUN SUMMARY                                 04740719
C****                                                                   04750719
90020 FORMAT (" ",21X,I5," TESTS PASSED" )                              04760719
90022 FORMAT (" ",21X,I5," TESTS FAILED" )                              04770719
90024 FORMAT (" ",21X,I5," TESTS DELETED" )                             04780719
90026 FORMAT (" ",21X,I5," TESTS REQUIRE INSPECTION" )                  04790719
90028 FORMAT (" ",21X,I5," OF ",I3," TESTS EXECUTED" )                  04800719
