...
37000   FORMAT(/2X, " LSTDI1 - (370) " ,                                01510923
     1         " LIST DIRECTED INPUT FOR SUBSET DATA TYPES" //          01520923
     2      3X," ANS REF. - 13.6  12.4" )                               01530923
...
70040      FORMAT (" ",16X,"COMPUTED: " ,1X,L1)                         02260923
           WRITE (NUVI,70040) AVB                                       02270923
70041      FORMAT (" ",16X,"CORRECT:  " ," T")                          02280923
...
70060      FORMAT (" ",16X,"COMPUTED: " ,I5,3(2X,I5))                   02600923
           WRITE (NUVI,70060) IVI,JVI,KVI,LVI                           02610923
70061      FORMAT (" ",16X,"CORRECT:  " ,                               02620923
     1       "   10",2X,"   15",2X,"   22",2X,"   40")                  02630923
...
70071      FORMAT (" ",16X,"COMPUTED: " ,F6.2,2X,F6.4,2X,F7.2)          02840923
           WRITE (NUVI,70071) AVS,BVS,CVS                               02850923
70072      FORMAT (" ",16X,"CORRECT:  " ,"100.50",2X,"0.0250",          02860923
     1     2X,"-162.50")                                                02870923
...
70081      FORMAT (" ",16X,"COMPUTED: " ,L1,4(2X,L1))                   02980923
           WRITE (NUVI,70081) AVB,BVB,CVB,DVB,EVB                       02990923
70082      FORMAT (" ",16X,"CORRECT:  " ,"T",2X,"F",2X,"F",2X,"T",2X,   03000923
     1       "F")                                                       03010923
...
70090      FORMAT (" ",16X,"COMPUTED: " ,A2,2X,A4,2X,A6)                03160923
           WRITE (NUVI,70090) A2VK,A4VK,A6VK                            03170923
70091      FORMAT (" ",16X,"CORRECT:  " ,"AB",2X,"ABCD",2X,"ABCDEF")    03180923
...
70100      FORMAT (" ",2X,I3,4X," FAIL  ",32X,                          03340923
     1     "COMPLEX IF - SEE SOURCE CODE" )                             03350923
           WRITE (NUVI,70100) IVTNUM                                    03360923
70101      FORMAT (" ",16X,"COMPUTED: " ,                               03370923
     2     A6,2X,L1,2X,F5.2,2X,I5,2X,E12.5)                             03380923
           WRITE (NUVI,70101) A6VK,AVB,AVS,IVI,BVS                      03390923
70102      FORMAT (" ",16X,"CORRECT:  " ,                               03400923
     1     "123456  T  17.50    -11" ,2X," 0.25000E+01 OR .25000+001" ) 03410923
...
70110      FORMAT (" ",2X,I3,4X," FAIL  ","MIXED DATA TYPES" ,16X,      03560923
     1     "COMPLEX IF - SEE SOURCE CODE" )                             03570923
           WRITE (NUVI,70110) IVTNUM                                    03580923
70111      FORMAT (" ",16X,"COMPUTED: " ,                               03590923
     1     I5,2X,A4,2X,L1,2X,F5.2)                                      03600923
           WRITE (NUVI,70111) IVI,A4VK,AVB,AVS                          03610923
70112      FORMAT (" ",16X,"CORRECT:  " ,                               03620923
     1     "   -5",2X,"2468",2X,"T",2X,"15.00")                         03630923
...
70120       FORMAT (" ",2X,I3,4X," FAIL  ","MIXED DATA TYPES" ,16X,     03790923
     1        "COMPLEX IF - SEE SOURCE CODE" )                          03800923
            WRITE (NUVI,70120) IVTNUM                                   03810923
70121       FORMAT (" ",16X,"COMPUTED: " ,                              03820923
     1      L1,2X,A4,2X,I5,2X,F4.2)                                     03830923
            WRITE (NUVI,70121) AVB,A4VK,IVI,AVS                         03840923
70122       FORMAT (" ",16X,"CORRECT:  " ,                              03850923
     2      "F  ","CHAR",2X,"   -5",2X,"0.25")                          03860923
...
70130      FORMAT (" ",16X,"COMPUTED: " ,I5,2X,I5,2X,I5)                04060923
           WRITE (NUVI,70130) J1I(1),J1I(2),J1I(3)                      04070923
70131      FORMAT (" ",16X,"CORRECT:  " ,                               04080923
     1       "    5",2X,"   10",2X,"   15")                             04090923
...
70140      FORMAT (" ",2X,I3,4X," FAIL  ","MIXED DATA TYPES" ,16X,      04230923
     1     "COMPLEX IF - SEE SOURCE CODE" )                             04240923
           WRITE (NUVI,70140) IVTNUM                                    04250923
70141      FORMAT (" ",16X,"COMPUTED: " ,E12.5,2X,L1,2X,L1,2X,I5,       04260923
     1     /27X,A2,2X,L1,2X,A4,2X,A4,2X,F5.2)                           04270923
           WRITE (NUVI,70141) AVS,AVB,BVB,IVI,A2VK,CVB,A4VK,B4VK,BVS    04280923
70142      FORMAT (" ",16X,"CORRECT:  " ,                               04290923
     1     " -.12500E+01" ,2X,"F",2X,"T",2X,"   -6",                    04300923
     2     /27X,"-6",2X,"F",2X,"ZYXW",2X,"DCBA",2X,"15.50")             04310923
...
70150      FORMAT (" ",2X,I3,4X," FAIL  ",32X,                          04480923
     1     "COMPLEX IF - SEE SOURCE CODE" )                             04490923
70151      FORMAT (" ",16X,"COMPUTED: " ,A4,2X,F4.1,2X,I5,2X,L1)        04500923
           WRITE (NUVI,70151) A4VK,AVS,IVI,AVB                          04510923
70152      FORMAT (" ",16X,"CORRECT:  " ,                               04520923
     1     "ONE    2.0      3  F" )                                     04530923
...
70160      FORMAT (" ",16X,"COMPUTED: " ,A4,2X,I5,2X,L1,2X,F4.1)        04700923
           WRITE (NUVI,70160) A4VK,IVI,AVB,AVS                          04710923
70161      FORMAT (" ",16X,"CORRECT:  " ,                               04720923
     1     "TWO       2  T   2.0" )                                     04730923
...
70170      FORMAT (" ",2X,I3,4X," FAIL  ",32X,                          04930923
     1     "COMPLEX IF - SEE SOURCE CODE" )                             04940923
70171      FORMAT (" ",16X,"COMPUTED: " ,                               04950923
     1     I5,6(2X,I5))                                                 04960923
           WRITE (NUVI,70171) IVI,IIVI,JVI,JJVI,KVI,KKVI,LVI            04970923
70172      FORMAT (" ",16X,"CORRECT:  " ,                               04980923
     1     "    2      4      6      8     10     12     14" )          04990923
...
70180      FORMAT (" ",2X,I3,4X," FAIL  ",32X,                          05210923
     1     "COMPLEX IF - SEE SOURCE CODE" )                             05220923
70181      FORMAT (" ",16X,"COMPUTED: " ,                               05230923
     1     I5,2X,F4.1,2X,I5,2X,L1,2X,F4.1,2X,A4,2X,                     05240923
     2     A4,2X,L1)                                                    05250923
           WRITE (NUVI,70181) JVI,BVS,IVI,AVB,AVS,A4VK,B4VK,BVB         05260923
70182      FORMAT (" ",16X,"CORRECT:  " ,                               05270923
     1     "    5",2X,"-2.5",2X,"    1",2X,"T",2X," 1.0",2X,"TRUE",2X,  05280923
     2     "TEST",2X,"F")                                               05290923
...
70190      FORMAT (" ",16X,"COMPUTED: " ,I5,4(2X,I5))                   05510923
           WRITE (NUVI,70190) IVI,JVI,KVI,LVI,MVI                       05520923
70191      FORMAT (" ",16X,"CORRECT:  " ,                               05530923
     1     "    6",2X,"    7",2X,"    8",2X,"    4",2X,"    5")         05540923
...
70200      FORMAT (" ",16X,"COMPUTED: " ,I5,2X,I5,2X,I5)                05700923
           WRITE (NUVI,70200) IVI,JVI,KVI                               05710923
70201      FORMAT (" ",16X,"CORRECT:  " ,                               05720923
     1     "12045",2X,"   12",2X,"   45")                               05730923
...
70210      FORMAT (" ",16X,"COMPUTED: " ,I5,2X,I5,2X,I5)                05900923
           WRITE (NUVI,70210) IVI,JVI,KVI                               05910923
70211      FORMAT (" ",16X,"CORRECT:  " ,                               05920923
     1     "12045",2X,"   12",2X,"   45")                               05930923
...
70240      FORMAT (" ",16X,"COMPUTED: " ,A15,2X,A8,2X,A9)               06390923
           WRITE (NUVI,70240) A15VK,A8VK,A9VK                           06400923
70241      FORMAT (" ",16X,"CORRECT:  " ,                               06410923
     1     "1234567890     " ,2X,"12345678",2X,"123456789")             06420923
...
70250      FORMAT (" ",2X,I3,4X," FAIL  ",32X,                          06590923
     1     "COMPLEX IF - SEE SOURCE CODE" )                             06600923
70251      FORMAT (" ",16X,"COMPUTED: " ,L1,7(2X,L1))                   06610923
           WRITE (NUVI,70251) AVB,BVB,CVB,DVB,EVB,FVB,GVB,HVB           06620923
70252      FORMAT (" ",16X,"CORRECT:  " ,"T  F  F  T  F  F  T  T" )     06630923
...
70260      FORMAT (" ",16X,"COMPUTED: " , L1,4(2X,L1))                  06790923
           WRITE (NUVI,70260) AVB,BVB,CVB,DVB,EVB                       06800923
70261      FORMAT (" ",16X,"CORRECT:  " ,"F  F  T  T  T" )              06810923
...
70280      FORMAT (" ",16X,"COMPUTED: " ,I5,2X,I5)                      07160923
           WRITE (NUVI,70280) IVI,JVI                                   07170923
70281      FORMAT (" ",16X,"CORRECT:  " ,"    5",2X,"    6")            07180923
...
C****                                                                   07440923
80000 FORMAT (" ",2X,I3,4X,"DELETED",32X,A31)                           07450923
80002 FORMAT (" ",2X,I3,4X," PASS  ",32X,A31)                           07460923
80004 FORMAT (" ",2X,I3,4X,"INSPECT",32X,A31)                           07470923
80008 FORMAT (" ",2X,I3,4X," FAIL  ",32X,A31)                           07480923
80010 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",15X,"COMPUTED= " ,           07490923
     1I6,/," ",15X,"CORRECT=  " ,I6)                                    07500923
80012 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           07510923
     1E12.5,/," ",16X,"CORRECT=  " ,E12.5)                              07520923
80018 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           07530923
     1A21,/," ",16X,"CORRECT=  " ,A21)                                  07540923
80020 FORMAT (" ",16X,"COMPUTED= " ,A21,1X,A31)                         07550923
80022 FORMAT (" ",16X,"CORRECT=  " ,A21,1X,A31)                         07560923
80024 FORMAT (" ",16X,"COMPUTED= " ,I6,16X,A31)                         07570923
80026 FORMAT (" ",16X,"CORRECT=  " ,I6,16X,A31)                         07580923
80028 FORMAT (" ",16X,"COMPUTED= " ,E12.5,10X,A31)                      07590923
80030 FORMAT (" ",16X,"CORRECT=  " ,E12.5,10X,A31)                      07600923
80050 FORMAT (" ",48X,A31)                                              07610923
CBE** ********************** BBCFMT0A **********************************07620923
CBB** ********************** BBCFMT0B **********************************07630923
C**** FORMAT STATEMENTS FOR PAGE HEADERS                                07640923
C****                                                                   07650923
90002 FORMAT ("1")                                                      07660923
90004 FORMAT (" ")                                                      07670923
90006 FORMAT (" ",20X,"NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY" )07680923
90007 FORMAT (" ",19X,"FORTRAN COMPILER VALIDATION SYSTEM" )            07690923
90008 FORMAT (" ",21X,A13,A17)                                          07700923
90009 FORMAT (" ",/," *",A5,"BEGIN*",12X,"TEST RESULTS   " ,A5,/)       07710923
90010 FORMAT (" ",8X,"TEST DATE*TIME= " ,A17,"     COMPILER= " ,A20)    07720923
90013 FORMAT (" "," TEST   ","PASS/FAIL " ,6X,"DISPLAYED RESULTS" ,     07730923
     1       7X,"REMARKS",24X)                                          07740923
90014 FORMAT (" ","----------------------------------------------" ,    07750923
     1        "---------------------------------" )                     07760923
90015 FORMAT (" ",48X,"THIS PROGRAM HAS " ,I3," TESTS",/)               07770923
C****                                                                   07780923
C**** FORMAT STATEMENTS FOR REPORT FOOTINGS                             07790923
C****                                                                   07800923
90016 FORMAT (" ",/," *",A5,"END*",14X,"END OF TEST - " ,A5,/)          07810923
90018 FORMAT (" ",A13,13X,A20,"   *   ",A10,"/",                        07820923
     1        A13)                                                      07830923
90019 FORMAT (" ","FOR OFFICIAL USE ONLY     " ,35X,"COPYRIGHT  1982" ) 07840923
C****                                                                   07850923
C**** FORMAT STATEMENTS FOR RUN SUMMARY                                 07860923
C****                                                                   07870923
90020 FORMAT (" ",21X,I5," TESTS PASSED" )                              07880923
90022 FORMAT (" ",21X,I5," TESTS FAILED" )                              07890923
90024 FORMAT (" ",21X,I5," TESTS DELETED" )                             07900923
90026 FORMAT (" ",21X,I5," TESTS REQUIRE INSPECTION" )                  07910923
90028 FORMAT (" ",21X,I5," OF ",I3," TESTS EXECUTED" )                  07920923
