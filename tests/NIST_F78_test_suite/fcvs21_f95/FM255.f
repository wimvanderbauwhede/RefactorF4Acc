...
C                                                                       09300255
      ...
      STOP                                                              09390255
90001 FORMAT (" ",24X,"FM255")                                          09400255
90000 FORMAT (" ",20X,"END OF PROGRAM FM255" )                          09410255
C                                                                       09420255
C     FORMATS FOR TEST DETAIL LINES                                     09430255
C                                                                       09440255
80000 FORMAT (" ",4X,I5,6X,"DELETED")                                   09450255
80002 FORMAT (" ",4X,I5,7X,"PASS")                                      09460255
80010 FORMAT (" ",4X,I5,7X,"FAIL",10X,I6,9X,I6)                         09470255
80012 FORMAT (" ",4X,I5,7X,"FAIL",4X,E12.5,3X,E12.5)                    09480255
80018 FORMAT (" ",4X,I5,7X,"FAIL",2X,A14,1X,A14)                        09490255
C                                                                       09500255
C     FORMAT STATEMENTS FOR PAGE HEADERS                                09510255
C                                                                       09520255
90002 FORMAT ("1")                                                      09530255
90004 FORMAT (" ")                                                      09540255
90006 FORMAT (" ",10X,"FORTRAN COMPILER VALIDATION SYSTEM" )            09550255
90008 FORMAT (" ",21X,"VERSION 2.1" )                                   09560255
90010 FORMAT (" ",8X,"FOR OFFICIAL USE ONLY - COPYRIGHT 1978" )         09570255
90012 FORMAT (" ",5X,"TEST",5X,"PASS/FAIL",5X,"COMPUTED",8X,"CORRECT")  09580255
90014 FORMAT (" ",5X,"----------------------------------------------" ) 09590255
90016 FORMAT (" ",18X,"SUBSET LEVEL TEST" )                             09600255
C                                                                       09610255
C     FORMAT STATEMENTS FOR RUN SUMMARY                                 09620255
C                                                                       09630255
90020 FORMAT (" ",19X,I5," TESTS FAILED" )                              09640255
90022 FORMAT (" ",19X,I5," TESTS PASSED" )                              09650255
90024 FORMAT (" ",19X,I5," TESTS DELETED" )                             09660255
      END                                                               09670255
