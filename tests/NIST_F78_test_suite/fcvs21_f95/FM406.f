...
39100   FORMAT(" ",/ " INTER2 - (391) INTERNAL FILES -- USING WRITE"    01030406
     1          //" SUBSET REF. - 12.2.5" )                             01040406
...
39199   FORMAT (" ",48X,"NOTE 1: OPTIONAL LEADING ZERO  " /             01150406
     1          " ",48X,"   MAY BE BLANK FOR ABSOLUTE   " /             01160406
     2          " ",48X,"   VALUE < 1                   " /             01170406
     3          " ",48X,"NOTE 2: LEADING PLUS SIGN IS   " /             01180406
     4          " ",48X,"   OPTIONAL                    " /             01190406
     5          " ",48X,"NOTE 3: E EXPONENT MAY BE E+   " /             01200406
     6          " ",48X,"   OR +0 BEFORE VALUE          " )             01210406
...
39112   FORMAT(F7.3,1X,L5,1X,I5,1X,A5,1X,'PROGRAMS',1X,"ONE")           03460406
           IVCOMP = 0                                                   03470406
...
39113   FORMAT(F9.4,1X,I4,1X,"BVS",1X,F9.4,1X,L1,1X,A3)                 03760406
           IVCOMP = 0                                                   03770406
...
C****                                                                   04260406
80000 FORMAT (" ",2X,I3,4X,"DELETED",32X,A31)                           04270406
80002 FORMAT (" ",2X,I3,4X," PASS  ",32X,A31)                           04280406
80004 FORMAT (" ",2X,I3,4X,"INSPECT",32X,A31)                           04290406
80008 FORMAT (" ",2X,I3,4X," FAIL  ",32X,A31)                           04300406
80010 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",15X,"COMPUTED= " ,           04310406
     1I6,/," ",15X,"CORRECT=  " ,I6)                                    04320406
80012 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           04330406
     1E12.5,/," ",16X,"CORRECT=  " ,E12.5)                              04340406
80018 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           04350406
     1A21,/," ",16X,"CORRECT=  " ,A21)                                  04360406
80020 FORMAT (" ",16X,"COMPUTED= " ,A21,1X,A31)                         04370406
80022 FORMAT (" ",16X,"CORRECT=  " ,A21,1X,A31)                         04380406
80024 FORMAT (" ",16X,"COMPUTED= " ,I6,16X,A31)                         04390406
80026 FORMAT (" ",16X,"CORRECT=  " ,I6,16X,A31)                         04400406
80028 FORMAT (" ",16X,"COMPUTED= " ,E12.5,10X,A31)                      04410406
80030 FORMAT (" ",16X,"CORRECT=  " ,E12.5,10X,A31)                      04420406
80050 FORMAT (" ",48X,A31)                                              04430406
CBE** ********************** BBCFMT0A **********************************04440406
CBB** ********************** BBCFMT0B **********************************04450406
C**** FORMAT STATEMENTS FOR PAGE HEADERS                                04460406
C****                                                                   04470406
90002 FORMAT ("1")                                                      04480406
90004 FORMAT (" ")                                                      04490406
90006 FORMAT (" ",20X,"NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY" )04500406
90007 FORMAT (" ",19X,"FORTRAN COMPILER VALIDATION SYSTEM" )            04510406
90008 FORMAT (" ",21X,A13,A17)                                          04520406
90009 FORMAT (" ",/," *",A5,"BEGIN*",12X,"TEST RESULTS - " ,A5,/)       04530406
90010 FORMAT (" ",8X,"TEST DATE*TIME= " ,A17,"  -  COMPILER= " ,A20)    04540406
90013 FORMAT (" "," TEST   ","PASS/FAIL " ,6X,"DISPLAYED RESULTS" ,     04550406
     1       7X,"REMARKS",24X)                                          04560406
90014 FORMAT (" ","----------------------------------------------" ,    04570406
     1        "---------------------------------" )                     04580406
90015 FORMAT (" ",48X,"THIS PROGRAM HAS " ,I3," TESTS",/)               04590406
C****                                                                   04600406
C**** FORMAT STATEMENTS FOR REPORT FOOTINGS                             04610406
C****                                                                   04620406
90016 FORMAT (" ",/," *",A5,"END*",14X,"END OF TEST - " ,A5,/)          04630406
90018 FORMAT (" ",A13,13X,A20,"   *   ",A10,"/",                        04640406
     1        A13)                                                      04650406
90019 FORMAT (" ","FOR OFFICIAL USE ONLY     " ,35X,"COPYRIGHT  1982" ) 04660406
C****                                                                   04670406
C**** FORMAT STATEMENTS FOR RUN SUMMARY                                 04680406
C****                                                                   04690406
90020 FORMAT (" ",21X,I5," TESTS PASSED" )                              04700406
90022 FORMAT (" ",21X,I5," TESTS FAILED" )                              04710406
90024 FORMAT (" ",21X,I5," TESTS DELETED" )                             04720406
90026 FORMAT (" ",21X,I5," TESTS REQUIRE INSPECTION" )                  04730406
90028 FORMAT (" ",21X,I5," OF ",I3," TESTS EXECUTED" )                  04740406
