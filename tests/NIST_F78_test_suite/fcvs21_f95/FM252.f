...
C                                                                       01120252
 ...
 0012 FORMAT (" **** ASSIGN FORMAT NUMBER TO INTEGER VARIABLE ****" )   01170252
...
C                                                                       04900252
      ...
      STOP                                                              04990252
90001 FORMAT (" ",24X,"FM252")                                          05000252
90000 FORMAT (" ",20X,"END OF PROGRAM FM252" )                          05010252
C                                                                       05020252
C     FORMATS FOR TEST DETAIL LINES                                     05030252
C                                                                       05040252
80000 FORMAT (" ",4X,I5,6X,"DELETED")                                   05050252
80002 FORMAT (" ",4X,I5,7X,"PASS")                                      05060252
80010 FORMAT (" ",4X,I5,7X,"FAIL",10X,I6,9X,I6)                         05070252
80012 FORMAT (" ",4X,I5,7X,"FAIL",4X,E12.5,3X,E12.5)                    05080252
80018 FORMAT (" ",4X,I5,7X,"FAIL",2X,A14,1X,A14)                        05090252
C                                                                       05100252
C     FORMAT STATEMENTS FOR PAGE HEADERS                                05110252
C                                                                       05120252
90002 FORMAT ("1")                                                      05130252
90004 FORMAT (" ")                                                      05140252
90006 FORMAT (" ",10X,"FORTRAN COMPILER VALIDATION SYSTEM" )            05150252
90008 FORMAT (" ",21X,"VERSION 2.1" )                                   05160252
90010 FORMAT (" ",8X,"FOR OFFICIAL USE ONLY - COPYRIGHT 1978" )         05170252
90012 FORMAT (" ",5X,"TEST",5X,"PASS/FAIL",5X,"COMPUTED",8X,"CORRECT")  05180252
90014 FORMAT (" ",5X,"----------------------------------------------" ) 05190252
90016 FORMAT (" ",18X,"SUBSET LEVEL TEST" )                             05200252
C                                                                       05210252
C     FORMAT STATEMENTS FOR RUN SUMMARY                                 05220252
C                                                                       05230252
90020 FORMAT (" ",19X,I5," TESTS FAILED" )                              05240252
90022 FORMAT (" ",19X,I5," TESTS PASSED" )                              05250252
90024 FORMAT (" ",19X,I5," TESTS DELETED" )                             05260252
      END                                                               05270252
