...
35300   FORMAT(/1X, "IOFMTS - (353) ADDITIONAL FORMATTED" /16X,         01300111
     1         "DATA TRANSFERS" ,//2X,                                  01310111
     2         "SUBSET REFS 12.9.5.2  13.1  13.5" )                     01320111
...
C****************************TEST 1 ********************                01720111
35302 FORMAT (" ",10X,"COMPUTED:  " , 2I5, 1X, E10.5, BN, 2I5, F6.1,    01730111
     1  BZ, F6.2, BN, 1X, E8.3, I5)                                     01740111
70010      FORMAT (" ",10X,"CORRECT:  " ,                               01750111
     1     "  1110 2020 .30303E-07   44   55   6.6 70.07" ,             01760111
     2     " .888E+01   99" )                                           01770111
...
35304 FORMAT ( /BN, 11X,"COMPUTED:  " , I5, F7.0, BZ, 1X, F5.2,         01860111
     1  2(1X,I4),I5, F7.0, BZ, 1X, F5.2, 2(1X, I4))                     01870111
70011      FORMAT (" ",10X,"CORRECT:  " ,                               01880111
     1     " 23450 10345. 12.45 1235 1234" ,                            01890111
     2     " 2345  1345. 12.45 1235 1234" )                             01900111
...
35306 FORMAT (/11X,"COMPUTED:  " ,                                      01980111
     1  I5, 2(3X, F2.1), I5, 3X, E5.1E1, 3X, F2.1, 3X, E6.1E1)          01990111
70012      FORMAT (" ",10X,"CORRECT:  " ,                               02000111
     1     "     0   .0   .0    0   .0E+0   .0   -.4E-2" /)             02010111
...
35307   FORMAT (" ",10X,"COMPUTED: " ,                                  02160111
     1  E9.5E1, 1X, E10.5E2, 1X, E11.5E3,1X,E11.5E4,1X,E10.5)           02170111
70020      FORMAT (" ",10X,"CORRECT:  " ,                               02180111
     1     "********* .12345E+10 .12345E+010 ***********" ,             02190111
     2     " .12345E+10" /)                                             02200111
...
35309   FORMAT (11X,"COMPUTED: " ,I5,1X,F5.2)                           02450111
70030      FORMAT (" ",10X,"CORRECT:  " ,                               02460111
     1     "    6 33.33" /)                                             02470111
...
C***************************************************                    02670111
        WRITE(NUVI,                                                     02680111
     1  '(/11X, "COMPUTED: " ,4(2X, I3)  )JUNK')                        02690111
     2  (J3I(1,2,IVI),IVI=1,3)                                          02700111
           WRITE (NUVI,                                                 02710111
     1     '(11X,"CORRECT:  " ,  "    2    4    6") ')                  02720111
        WRITE (NUVI,                                                    02730111
     1  '(/11X,"COMPUTED:"," ''THAT''S ALL FOR NOW''")')                02740111
70040      FORMAT (11X,"CORRECT:  " ,                                   02750111
     1     "'THAT'S ALL FOR NOW'" )                                     02760111
...
C****                                                                   03030111
80000 FORMAT (" ",2X,I3,4X,"DELETED",32X,A31)                           03040111
80002 FORMAT (" ",2X,I3,4X," PASS  ",32X,A31)                           03050111
80004 FORMAT (" ",2X,I3,4X,"INSPECT",32X,A31)                           03060111
80008 FORMAT (" ",2X,I3,4X," FAIL  ",32X,A31)                           03070111
80010 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",15X,"COMPUTED= " ,           03080111
     1I6,/," ",15X,"CORRECT=  " ,I6)                                    03090111
80012 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           03100111
     1E12.5,/," ",16X,"CORRECT=  " ,E12.5)                              03110111
80018 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           03120111
     1A21,/," ",16X,"CORRECT=  " ,A21)                                  03130111
80020 FORMAT (" ",16X,"COMPUTED= " ,A21,1X,A31)                         03140111
80022 FORMAT (" ",16X,"CORRECT=  " ,A21,1X,A31)                         03150111
80024 FORMAT (" ",16X,"COMPUTED= " ,I6,16X,A31)                         03160111
80026 FORMAT (" ",16X,"CORRECT=  " ,I6,16X,A31)                         03170111
80028 FORMAT (" ",16X,"COMPUTED= " ,E12.5,10X,A31)                      03180111
80030 FORMAT (" ",16X,"CORRECT=  " ,E12.5,10X,A31)                      03190111
80050 FORMAT (" ",48X,A31)                                              03200111
CBE** ********************** BBCFMT0A **********************************03210111
CBB** ********************** BBCFMT0B **********************************03220111
C**** FORMAT STATEMENTS FOR PAGE HEADERS                                03230111
C****                                                                   03240111
90002 FORMAT ("1")                                                      03250111
90004 FORMAT (" ")                                                      03260111
90006 FORMAT (" ",20X,"NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY" )03270111
90007 FORMAT (" ",19X,"FORTRAN COMPILER VALIDATION SYSTEM" )            03280111
90008 FORMAT (" ",21X,A13,A17)                                          03290111
90009 FORMAT (" ",/," *",A5,"BEGIN*",12X,"TEST RESULTS - " ,A5,/)       03300111
90010 FORMAT (" ",8X,"TEST DATE*TIME= " ,A17,"  -  COMPILER= " ,A20)    03310111
90013 FORMAT (" "," TEST   ","PASS/FAIL " ,6X,"DISPLAYED RESULTS" ,     03320111
     1       7X,"REMARKS",24X)                                          03330111
90014 FORMAT (" ","----------------------------------------------" ,    03340111
     1        "---------------------------------" )                     03350111
90015 FORMAT (" ",48X,"THIS PROGRAM HAS " ,I3," TESTS",/)               03360111
C****                                                                   03370111
C**** FORMAT STATEMENTS FOR REPORT FOOTINGS                             03380111
C****                                                                   03390111
90016 FORMAT (" ",/," *",A5,"END*",14X,"END OF TEST - " ,A5,/)          03400111
90018 FORMAT (" ",A13,13X,A20,"   *   ",A10,"/",                        03410111
     1        A13)                                                      03420111
90019 FORMAT (" ","FOR OFFICIAL USE ONLY     " ,35X,"COPYRIGHT  1982" ) 03430111
C****                                                                   03440111
C**** FORMAT STATEMENTS FOR RUN SUMMARY                                 03450111
C****                                                                   03460111
90020 FORMAT (" ",21X,I5," TESTS PASSED" )                              03470111
90022 FORMAT (" ",21X,I5," TESTS FAILED" )                              03480111
90024 FORMAT (" ",21X,I5," TESTS DELETED" )                             03490111
90026 FORMAT (" ",21X,I5," TESTS REQUIRE INSPECTION" )                  03500111
90028 FORMAT (" ",21X,I5," OF ",I3," TESTS EXECUTED" )                  03510111
