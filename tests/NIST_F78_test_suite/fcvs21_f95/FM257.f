...
C                                                                       02600257
      ...
      STOP                                                              02690257
90001 FORMAT (" ",24X,"FM257")                                          02700257
90000 FORMAT (" ",20X,"END OF PROGRAM FM257" )                          02710257
C                                                                       02720257
C     FORMATS FOR TEST DETAIL LINES                                     02730257
C                                                                       02740257
80000 FORMAT (" ",4X,I5,6X,"DELETED")                                   02750257
80002 FORMAT (" ",4X,I5,7X,"PASS")                                      02760257
80010 FORMAT (" ",4X,I5,7X,"FAIL",10X,I6,9X,I6)                         02770257
80012 FORMAT (" ",4X,I5,7X,"FAIL",4X,E12.5,3X,E12.5)                    02780257
80018 FORMAT (" ",4X,I5,7X,"FAIL",2X,A14,1X,A14)                        02790257
C                                                                       02800257
C     FORMAT STATEMENTS FOR PAGE HEADERS                                02810257
C                                                                       02820257
90002 FORMAT ("1")                                                      02830257
90004 FORMAT (" ")                                                      02840257
90006 FORMAT (" ",10X,"FORTRAN COMPILER VALIDATION SYSTEM" )            02850257
90008 FORMAT (" ",21X,"VERSION 2.1" )                                   02860257
90010 FORMAT (" ",8X,"FOR OFFICIAL USE ONLY - COPYRIGHT 1978" )         02870257
90012 FORMAT (" ",5X,"TEST",5X,"PASS/FAIL",5X,"COMPUTED",8X,"CORRECT")  02880257
90014 FORMAT (" ",5X,"----------------------------------------------" ) 02890257
90016 FORMAT (" ",18X,"SUBSET LEVEL TEST" )                             02900257
C                                                                       02910257
C     FORMAT STATEMENTS FOR RUN SUMMARY                                 02920257
C                                                                       02930257
90020 FORMAT (" ",19X,I5," TESTS FAILED" )                              02940257
90022 FORMAT (" ",19X,I5," TESTS PASSED" )                              02950257
90024 FORMAT (" ",19X,I5," TESTS DELETED" )                             02960257
      END                                                               02970257
