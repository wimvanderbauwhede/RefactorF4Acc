...
subroutine stage_kernel_1(global_id_0,p0_0,rhs_0,p4_1)
 ...
 real, dimension(1:530803568) :: p4_1
...
!RF4A Begin Inline
 ...
 if (idx+s1(s_idx_1)+s1(s_idx_2)+s1(s_idx_3)+s1(s_idx_4)>=1 .and.  &
      idx+s1(s_idx_1)+s1(s_idx_2)+s1(s_idx_3)+s1(s_idx_4)<=530803568) then
 ...
 if (idx+s1(s_idx_1)+s1(s_idx_2)+s1(s_idx_3)>=1 .and.  &
      idx+s1(s_idx_1)+s1(s_idx_2)+s1(s_idx_3)<=530803568) then
 ...
 do s_idx_1 = 1,9
 do s_idx_2 = 1,9
 if (idx+s1(s_idx_1)+s1(s_idx_2)>=1 .and. idx+s1(s_idx_1)+s1(s_idx_2)<=530803568) then
 ...
 i_range___sor_map_23_scal = ((2401 - 0) + 1)
 j_range___sor_map_23_scal = ((2401 - 0) + 1)
 ...
 if (i___sor_map_23_scal == 150 * 16 + 1) then
...
else if ( j___sor_map_23_scal == 150 * 16 + 1 ) then
 sv_p1_s_0_in___f_comp_p4_1_5(i___f_maps_p4_1_4,i___f_maps_p4_1_2) = svec_p4_1_11(i___f_maps_p4_1_7, &
 ...
 i_range___sor_map_47_scal = ((2401 - 0) + 1)
 j_range___sor_map_47_scal = ((2401 - 0) + 1)
 ...
 if (i___sor_map_47_scal == 150 * 16 + 1) then
...
else if ( j___sor_map_47_scal == 150 * 16 + 1 ) then
 sv_p2_s_0_in___f_comp_p4_1_8(i___f_maps_p4_1_7, &
 ...
 i_range___sor_map_71_scal = ((2401 - 0) + 1)
 j_range___sor_map_71_scal = ((2401 - 0) + 1)
 ...
 if (i___sor_map_71_scal == 150 * 16 + 1) then
...
else if ( j___sor_map_71_scal == 150 * 16 + 1 ) then
 ...
 i_range___sor_map_95_scal = ((2401 - 0) + 1)
 j_range___sor_map_95_scal = ((2401 - 0) + 1)
