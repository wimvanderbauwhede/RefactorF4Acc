...
subroutine stage_kernel_1(global_id_0,p0_0,rhs_0,p3_1)
 ...
 real, dimension(1:829104368) :: p3_1
...
!RF4A Begin Inline
 ...
 i_range___sor_map_22_scal = ((3001 - 0) + 1)
 j_range___sor_map_22_scal = ((3001 - 0) + 1)
 ...
 if (i___sor_map_22_scal == 150 * 20 + 1) then
 ...
 sv_p1_s_0_in___f_comp_p3_1_4(i___f_maps_p3_1_3,i___f_maps_p3_1_1) = svec_p3_1_7(i___f_maps_p3_1_3, &
      i___f_maps_p3_1_1,7)
else if ( j___sor_map_22_scal == 150 * 20 + 1 ) then
 sv_p1_s_0_in___f_comp_p3_1_4(i___f_maps_p3_1_3,i___f_maps_p3_1_1) = svec_p3_1_7(i___f_maps_p3_1_3, &
      i___f_maps_p3_1_1,4)
 ...
 i_range___sor_map_46_scal = ((3001 - 0) + 1)
 j_range___sor_map_46_scal = ((3001 - 0) + 1)
 ...
 if (i___sor_map_46_scal == 150 * 20 + 1) then
...
else if ( j___sor_map_46_scal == 150 * 20 + 1 ) then
 ...
 i_range___sor_map_70_scal = ((3001 - 0) + 1)
 j_range___sor_map_70_scal = ((3001 - 0) + 1)
