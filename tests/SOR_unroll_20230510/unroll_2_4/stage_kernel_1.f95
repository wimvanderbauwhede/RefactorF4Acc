...
subroutine stage_kernel_1(global_id_0,p0_0,rhs_0,p2_1)
 ...
 real, dimension(1:33341168) :: p2_1
...
!RF4A Begin Inline
 ...
 i_range___sor_map_21_scal = ((601 - 0) + 1)
 j_range___sor_map_21_scal = ((601 - 0) + 1)
 ...
 if (i___sor_map_21_scal == 150 * 4 + 1) then
...
else if ( j___sor_map_21_scal == 150 * 4 + 1 ) then
 ...
 i_range___sor_map_45_scal = ((601 - 0) + 1)
 j_range___sor_map_45_scal = ((601 - 0) + 1)
