module SOLN
      use params_SOLN, only : lzd, lelv, lx2, lbz1, ldim, lorder, lpy2, lpx2, lz1, lbx2, lpert, &
       lby2, lpz1, ly2, lpx1, lpy1, ldimt, lelt, lbz2, lz2, lpelt, lxd, ly1, lbelv, lpz2, lyd, &
       lby1, lbx1, lx1, lorder2, lpelv, ldimt1
