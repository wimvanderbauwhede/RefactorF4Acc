module singleton_module_src_mxm_bgq
...
contains
      ...
      real :: vec_madd
          ...
          real(kind=8), dimension(1:n1,1:n2), intent(In) :: a
          real(kind=8), dimension(1:n2,1:n3), intent(In) :: b
          real(kind=8), dimension(1:n1,1:n3), intent(In) :: c
          integer :: i
          integer :: j
...
end module singleton_module_src_mxm_bgq
