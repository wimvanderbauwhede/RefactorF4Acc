module TOTAL
      use params_TOTAL, only : numsts, lelv, lbz2, lbx1, lorder2, maxmbr, lpy1, lz1m, lorder, ly3, &
       lx1m, ly2, lpx2, ldim, lby2, lhis, lzd, lx1, lpz1, lbelv, lxd, lz1, lpelt, maxobj, ldimt1, &
       lyd, ldimt, ly1, lbz1, lpelv, lbx2, lpy2, lelg, lpx1, lz3, ly1m, lx2, lpert, lx3, lby1, &
       lz2, lelt, ldimt3, lxq, lpz2
