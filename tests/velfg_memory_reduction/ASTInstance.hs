...
ast = [
       ...
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov1_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s10")) (Vec VT (Scalar VDC DFloat "cov1_1")))
       ...
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov3_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s14")) (Vec VT (Scalar VDC DFloat "cov3_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu4_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s15")) (Vec VT (Scalar VDC DFloat "diu4_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu3_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s16")) (Vec VT (Scalar VDC DFloat "diu3_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu8_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s17")) (Vec VT (Scalar VDC DFloat "diu8_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov4_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s18")) (Vec VT (Scalar VDC DFloat "cov4_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu9_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s19")) (Vec VT (Scalar VDC DFloat "diu9_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov7_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s20")) (Vec VT (Scalar VDC DFloat "cov7_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov9_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s21")) (Vec VT (Scalar VDC DFloat "cov9_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu7_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s22")) (Vec VT (Scalar VDC DFloat "diu7_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "diu2_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s23")) (Vec VT (Scalar VDC DFloat "diu2_1")))
       ,(Vec VS (SVec 2 (Scalar VDC DFloat "cov2_s_0" )) , Stencil (SVec 2 (Scalar VDC DInt "s24")) (Vec VT (Scalar VDC DFloat "cov2_1")))
...
stencilDefinitionsList = [("s1" , [23561,23562,23713,46817] ), ("s2" , [305,23409,23560,23561,23712] ), ("s3" , [305,23409,23410,23560,23561] ), ("s4" , [46665,46816,46817] ), ("s5" , [23560,46816] ), ("s6" , [23409,46665] ), ("s7" , [23718,23719] ), ("s8" , [23718,23872] ), ("s9" , [23563,46972] ), ("s10" , [23718,23719] ), ("s11" , [23718,23872] ), ("s12" , [23563,46972] ), ("s13" , [23563,23716] ), ("s14" , [23563,46972] ), ("s15" , [23563,23564] ), ("s16" , [23563,46972] ), ("s17" , [23563,23716] ), ("s18" , [23563,23564] ), ("s19" , [23563,46972] ), ("s20" , [23563,23564] ), ("s21" , [23563,46972] ), ("s22" , [23563,23564] ), ("s23" , [23563,23716] ), ("s24" , [23563,23716] )]
...
main (w_0,u_0,v_0,dx1_0,dy1_0,dzn_0,dzs_0) =
  let
    ...
    s8 = [23718,23872]
    cov5_s_0 = stencil s8 cov5_1
    s9 = [23563,46972]
    cov6_s_0 = stencil s9 cov6_1
    s10 = [23718,23719]
    cov1_s_0 = stencil s10 cov1_1
    s11 = [23718,23872]
    diu5_s_0 = stencil s11 diu5_1
    s12 = [23563,46972]
    diu6_s_0 = stencil s12 diu6_1
    s13 = [23563,23716]
    cov8_s_0 = stencil s13 cov8_1
    s14 = [23563,46972]
    cov3_s_0 = stencil s14 cov3_1
    s15 = [23563,23564]
    diu4_s_0 = stencil s15 diu4_1
    s16 = [23563,46972]
    diu3_s_0 = stencil s16 diu3_1
    s17 = [23563,23716]
