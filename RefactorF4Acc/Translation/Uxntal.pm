    ...
    if ($rhs_ast->[0] == 34 or $rhs_ast->[0] == 1 or $rhs_ast->[0] == 13) { # string literal or function returning a string or char
        ...
        if ($lhs_idx_expr_type == 2) { # slice
            ...
            if ($lhs_idx_expr_b eq $lhs_idx_expr_e ) {
                ...
                my $lhs_idx_expr =  ($lhs_idx_expr_b eq '#0001') ? '#0002 ADD2' : "$lhs_idx_expr_b ADD2 INC2 ";
                $uxntal_code = "$rhs_Uxntal_expr #0002 ADD2 LDA $lhs_var_access $lhs_idx_expr STA";
                ...
                $uxntal_code = "$rhs_Uxntal_expr $lhs_var_access $lhs_idx_expr_b #0001 SUB2 ADD2 ".
