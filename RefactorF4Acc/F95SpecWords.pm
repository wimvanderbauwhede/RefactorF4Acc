...
# Numeric Functions
    'abs' => [['a'],'a'],
    'aimag' => [['complex'],'real'],
    'aint' => [['real','kind'],'real'], # kind
    'anint' => [['real','kind'],'real'], # kind
    'ceiling' => [['real','kind'],'integer'], # kind
    'cmplx' => [['a','a','kind'],'complex'], # kind
    'conjg' => [['complex'],'complex'],
    'dble' => [['a'],'real(kind=8)'],
    'dim' => [['a','a'],'a'],
    'dprod' => [['real(8)','real(8)'],'real(8)'],
    'exponent' => [['real'],'real'],
    'floor' => [['real','kind'],'integer'], # kind
    'fraction' => [['real'],'real'],
    'int' => [['a','kind'],'integer'], # kind
    'logical' =>[['a','kind'],'logical'], # kind
    'max' => [['a','a'],'a'],
    'min' => [['a','a'],'a'],
    'mod' => [['a','a'],'a'],
    'modulo' => [['a','a'],'a'],
    'nearest' => [['real','real'],'real'],
    'nint' => [['real','kind'],'integer'], # kind
    'real' => [['a','kind'],'real'], # kind
    'rrspacing' => [['real'],'real'],
    ...
    'char'=> [['integer','kind'], 'character'], # kind
    'iachar'=> [['character','kind'], 'integer'], # kind
    'ichar'=> [['character','kind'], 'integer'], # kind
    'index' => [['character(*)','character(*)','logical','kind'],'integer'], # kind
    'len' => [['character(*)','kind'],'integer'], # kind
    'len_trim' => [['character(*)','kind'],'integer'], # kind
