module CommonBlockTypecheckRules (commonBlockTypecheck) where
import FTypes 

commonBlockTypecheck 
...
-- main =  print $ commonBlockTypecheck (FReal, Array, 4, 2, 1) (FComplex, Scalar, 4, 0,0)   
